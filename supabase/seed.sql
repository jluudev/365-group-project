...
INSERT INTO hero (name, power, health, guild_id, dungeon_id, world_id, level, xp, status) VALUES
    ('Dead1', 10, 0, 1, 1, 1, 1, 0, 'alive'),
    ('Dead2', 10, 0, 1, 1, 1, 1, 0, 'alive'),
    ('Dead3', 10, 0, 1, 1, 1, 1, 0, 'alive')
;
